          ...
          <div class="flex flex-wrap -mx-4">
            <div class="w-full px-4">
                <div class="relative mx-auto max-w-[525px] overflow-hidden rounded-lg bg-white py-16 px-10 text-center sm:px-12 md:px-[60px] dark:bg-dark-2">
                  ...
                  <form>
                      <div class="mb-6">
                        <input value={email} onChange={(e) => setEmail(e.target.value)} type="text" placeholder="Email" class="w-full px-5 py-3 text-base bg-transparent border rounded-md outline-none border-stroke text-body-color  dark:border-dark-3 focus:border-primary focus-visible:shadow-none"/>
                      </div>
                      <div class="mb-6">
                      ...
                      <div class="mb-10">
                        <input onClick={handleLogin} type="submit" value="Sign In" class="w-full px-5 py-3 text-base font-medium  transition border rounded-md cursor-pointer border-primary bg-primary bg-blue-600 hover:bg-blue-700" />
                      </div>
                  </form>
                  ...
                  <a href="javascript:void(0)" class="inline-block mb-2 text-base text-dark dark:text-white hover:text-primary hover:underline">
                    Forget Password?
                  </a>
                  <p class="text-base text-body-color dark:text-dark-6">
                      <span class="pr-0.5">Not a member yet?</span>
                      <Link to={'/register'} class="text-primary hover:underline text-blue-600">Sign Up</Link>
                  </p>
                  <div>
